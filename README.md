<div style="display: flex; align-items: center;">
  <div>
    <img src="https://github.com/yerroong/yerroong/blob/main/profile.jpg?raw=true" alt="김예린 사진" style="border-radius:50%; max-width: 100px; height: auto; margin-right: 20px;">
  </div>
  <div>
    <p>
